...
const channelReducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case DELETE_CHANNEL:
            ...
            if (
                Object.keys(newState.channels.user_channels).includes(
                    action.payload.id
                )
            ) {
            ...
            if (
                Object.keys(newState.channels.single_channel).includes(
                    action.payload.id
                )
            ) {
        ...
        case EDIT_CHANNEL:
            ...
            if (
                ...
                newState.channels.user_channels[action.payload.id] =
                    action.payload;
            }
            if (
                Object.keys(newState.channels.single_channel).includes(
