...
const ErrorList = ({ errors, hasSubmitted }) => (
	<ul
		style={{ paddingTop: "10px", margin: "0px 0px 0px 28px", color: "red" }}
	>
		{hasSubmitted &&
				...
				{!currChannel.is_direct ? (
					<div className="edit-modal-form-box">
						...
						>
							Type &quot;
							<span
								style={{ color: "#631965", fontWeight: "bold" }}
							>
								{currChannel.name}
							</span>
							&quot; below to confirm the deletion of the channel
						</p>
						<input
							autoComplete="off"
							type="text"
						...
						/>
						<button
							disabled={confirmDeleteName !== currChannel.name}
							className="decorated-button-delete-channel"
