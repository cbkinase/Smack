...
def seed_users():
    demo = User(
        username='Demo', email='demo@aa.io', password='verysecurepassword??xd', first_name='Demo', last_name='User', avatar='https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/President_Barack_Obama.jpg/330px-President_Barack_Obama.jpg', bio='Hello, I\'m Demo User.  Nice to meet you!')
    marnie = User(
