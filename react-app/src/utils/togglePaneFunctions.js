export function toggleLeftPane () {
	if (document.getElementById("grid-container")) {
		...
		const isGridContainerHidingRight = document.getElementById("grid-container").className === "grid-container-hiderightside";

		if ((clientWidth > 1027) || (clientWidth >= 768 && isGridContainerHidingRight)) {
