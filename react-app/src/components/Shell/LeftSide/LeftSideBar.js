		...
		<div id="grid-leftside" className="grid-leftside-threecolumn">
			<div className="leftside-link-holder">
				<div className="leftside-channeldirect-holder">
						...
						<div>
							{/explore/.test(window.location.href) ? (
								...
								>
									...
									<span className="ellipsis-if-long">
										Explore Channels
									</span>
								</button>
							) : (
					...
					<NavLink onClick={closeRightPane} to={"/channels/direct"}>
						<div>
					...
					<div>
						<OpenModalButton
							modalComponent={
								<CreateChannelModal user={sessionUser} />
							}
			...
			<div
				id="last-leftside-holder"
				className="leftside-channeldirect-holder"
			>
				...
				<LeftSideBarDMSection
					user={sessionUser}
					channels={userChannelList.filter(
