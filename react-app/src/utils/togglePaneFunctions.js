...
export function hideShowLeftPane() {
	if (
		...
		document.getElementById("hideshow-leftpane-hamburger").style.display =
			"none";
		document.getElementById("hideshow-leftpane-arrow").style.display =
			"block";
...
function changedViewChannelsToClosed() {
	if (document.querySelector(".view-all-channels")) {
		document.getElementsByClassName("view-all-channels")[0].className =
			"view-all-channels-left-closed";
	}
}
