...
export default function PublicIntro({ channel, user }) {
    ...
    const addPeopleBtn = <OpenModalButton
    ...
    const editChannelBtn = <OpenModalButton
            className="channel-intro-btn"
            renderPencil={true}
            modalComponent={
                <EditChannelModal
    ...
    return (
        <div className="channel-intro-container">
            ...
            <p className="channel-intro-about">
                ...
                created this channel on {formattedDate}.{" "}
                This is the very beginning of the <span id="channel-intro-sub">{channelName}</span> channel.
